...
var Mutation = (_f = class extends Removable {
  ...
  async execute(variables) {
    var _a3, _b3, _c2, _d2, _e2, _f2, _g2, _h2, _i2, _j2, _k2, _l, _m, _n, _o, _p, _q, _r, _s, _t;
    const onContinue = () => {
...
let Certificate$1 = (_j = class {
  ...
  static async create(options) {
    const cert = _j.createUnverified(options);
    await cert.verify();
    return cert;
  }
  static createUnverified(options) {
    return new _j(options.certificate, options.rootKey, options.canisterId, options.blsVerify ?? blsVerify, options.maxAgeInMinutes, options.disableTimeVerification, options.agent);
  }
  /**
  ...
  async _checkDelegationAndGetKey(d2) {
    ...
    const cert = _j.createUnverified({
...
}, _disableTimeVerification = new WeakMap(), _agent = new WeakMap(), _j);
...
Service({
  "addCertificate": Func([Text, Time], [], []),
  "getAllJobs": Func([], [Vec(SigningJob)], ["query"]),
  "getAllJobsByCertificate": Func([], [Vec(SigningJob)], ["query"]),
  "getCertificates": Func([], [Vec(Certificate)], ["query"]),
  "getJobStatus": Func([Text], [JobStatus], ["query"]),
  "submitSigningJob": Func([Text, Text], [Text], []),
  "updateJobStatus": Func([Text, JobStatus], [], [])
});
...
`;
function generatePlist(ipaUrl, appName) {
...
function App() {
  ...
  const p12InputRef = reactExports.useRef(null);
  const provisionInputRef = reactExports.useRef(null);
  const [ipaFile, setIpaFile] = reactExports.useState(null);
  const [useManualCert, setUseManualCert] = reactExports.useState(false);
  const [selectedCert, setSelectedCert] = reactExports.useState("");
  const [p12File, setP12File] = reactExports.useState(null);
  const [provisionFile, setProvisionFile] = reactExports.useState(null);
  const [password, setPassword] = reactExports.useState("");
  const [signState, setSignState] = reactExports.useState("idle");
  const [progress, setProgress] = reactExports.useState(0);
  const [statusText, setStatusText] = reactExports.useState("");
  const [installURL, setInstallURL] = reactExports.useState("#");
  ...
  const handleFileChange = (e) => {
    var _a3;
    setIpaFile(((_a3 = e.target.files) == null ? void 0 : _a3[0]) ?? null);
  };
  const handleDrop = (e) => {
    var _a3;
    e.preventDefault();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "signer-form", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "AppleJr IPA Signer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: ipaFile ? `📦 ${ipaFile.name}
(${formatSize(ipaFile.size)})` : "📥 Click here to Upload IPA"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "toggle-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🔐 Manual Certificate" }),
      ...
      !useManualCert && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "serverCertSection", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-label", children: [
          "📁 Select from Server",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "-- Select Certificate --" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "0. National Oilwell", children: "0. National Oilwell" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1. VIETNAM AIRLINES", children: "1. VIETNAM AIRLINES" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "2. Qingdao", children: "2. Qingdao" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "3. Forevermark", children: "3. Forevermark" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "4. China Academy", children: "4. China Academy" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "5. ChinaTelecom", children: "5. ChinaTelecom" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "6. Vientin", children: "6. Vientin" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "7. Commission on Elections", children: "7. Commission on Elections" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "8. Atianjin", children: "8. Atianjin" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "9. Central", children: "9. Central" })
            ]
          }
        )
      ] }),
      useManualCert && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "manualCertSection", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "p12-input", className: "form-label", children: "🗳️ Certificate (.p12)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "file-input-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "p12-input",
            ref: p12InputRef,
            ...
            onChange: (e) => {
              var _a3;
              return setP12File(((_a3 = e.target.files) == null ? void 0 : _a3[0]) ?? null);
            },
            "data-ocid": "p12.upload_button"
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "provision-input", className: "form-label", children: "📄 MobileProvision" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "file-input-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "provision-input",
            ...
            onChange: (e) => {
              var _a3;
              return setProvisionFile(((_a3 = e.target.files) == null ? void 0 : _a3[0]) ?? null);
            },
            "data-ocid": "provision.upload_button"
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "cert-password", className: "form-label", children: "🔑 Certificate Password" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "cert-password",
      ...
      signState === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      signState === "signing" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "loader", "data-ocid": "sign.loading_state", children: [
          "⏳ ",
          statusText || "Signing... please wait"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-bar-wrap", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
      ...
      signState === "done" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "result-btns", "data-ocid": "result.panel", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            id: "installLink",
