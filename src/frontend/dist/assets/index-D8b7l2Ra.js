...
function App() {
  ...
  const handleFileChange = (e) => {
    var _a2;
    setIpaFile(((_a2 = e.target.files) == null ? void 0 : _a2[0]) ?? null);
  };
  const handleDrop = (e) => {
    var _a2;
    e.preventDefault();
  ...
  const handleSign = async () => {
    ...
    const plistUrl = CERT_PLIST_MAP[selectedCert] ?? "https://applejr.net/post/oilesign.plist";
...
(${formatSize(ipaFile.size)})` : "📥 Click here to Upload IPA"
      ...
      useManualCert && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "manualCertSection", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "file-input-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => {
              var _a2;
              return setP12File(((_a2 = e.target.files) == null ? void 0 : _a2[0]) ?? null);
            },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "file-input-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => {
              var _a2;
              return setProvisionFile(((_a2 = e.target.files) == null ? void 0 : _a2[0]) ?? null);
            },
      ...
      signState === "signing" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loader", "data-ocid": "sign.loading_state", children: "⏳ Signing... please wait" }),
      ...
      signState === "done" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "result-btns", "data-ocid": "result.panel", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: "📲 Install on iPhone (Step 2)"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            id: "downloadLink",
            href: downloadURL,
            download: (ipaFile == null ? void 0 : ipaFile.name) ?? "app.ipa",
